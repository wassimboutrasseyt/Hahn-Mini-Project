...
import com.whyboutrasseyt.miniproject.presentation.request.CreateTaskRequest;
import com.whyboutrasseyt.miniproject.presentation.response.TaskResponse;
...
public class TaskController {
    ...
    public ResponseEntity<TaskResponse> toggleCompleted(
            @AuthenticationPrincipal UserPrincipal principal,
            @PathVariable Long id
    ) {
        TaskDto dto = taskService.toggleCompleted(principal.domainUser().id(), id);
        return ResponseEntity.ok(toResponse(dto));
    }
